...
export declare function firstIndexOf<T>(xs: T[], predicate: (t: T) => boolean): Maybe<number>;
export declare function lastIndexOf<T>(xs: T[], predicate: (t: T) => boolean): Maybe<number>;
